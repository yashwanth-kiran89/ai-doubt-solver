...
const AppRoutes = () => (
  <Routes>
    ...
    {/* NEW DOUBT SYSTEM ROUTES - ADD THESE */}
    <Route path="/ask-doubt" element={<PrivateRoute><AskDoubt /></PrivateRoute>} />
    <Route path="/doubt-history" element={<PrivateRoute><DoubtHistory /></PrivateRoute>} />
